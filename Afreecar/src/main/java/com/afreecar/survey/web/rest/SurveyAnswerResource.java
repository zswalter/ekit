...
import com.afreecar.survey.repository.SurveyAnswerRepository;
...
/**
 * REST controller for managing {@link com.afreecar.survey.domain.SurveyAnswer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class SurveyAnswerResource {
    ...
    public ResponseEntity<SurveyAnswer> createSurveyAnswer(@Valid @RequestBody SurveyAnswer surveyAnswer) throws URISyntaxException {
    ...
    public ResponseEntity<SurveyAnswer> updateSurveyAnswer(@Valid @RequestBody SurveyAnswer surveyAnswer) throws URISyntaxException {
