...
/**
 * REST controller for managing {@link com.afreecar.survey.domain.SurveyQuestion}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class SurveyQuestionResource {
    ...
    public ResponseEntity<SurveyQuestion> createSurveyQuestion(@Valid @RequestBody SurveyQuestion surveyQuestion) throws URISyntaxException {
    ...
    public ResponseEntity<SurveyQuestion> updateSurveyQuestion(@Valid @RequestBody SurveyQuestion surveyQuestion) throws URISyntaxException {
